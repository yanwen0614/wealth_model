...
> 2026-09-12 状态同步：本任务未执行即被后续工作取代 —— train.py 现状已有 --dual_head/--pure_reg/--lambda_reg 接线；全表 pending → superseded，不再恢复。

## 任务列表

| Task | 名称 | 状态 | Quality Gate | 备注 |
|------|------|------|--------------|------|
| T01 | Dataset返y_ret | superseded | - | data/dataset.py +15 |
| T02 | 模型双头 | superseded | - | model.py +30 |
| T03 | DualLoss | superseded | - | dual_loss.py +80新建 |
| T04 | Trainer兼容 | superseded | - | trainer.py +40 |
| T05 | train开关+冒烟 | superseded | - | train.py +40，对比表 |
